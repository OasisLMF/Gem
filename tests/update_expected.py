...
default_kwargs = {
    "lookup_module_path": os.path.abspath("../src/keys_server/GMO"),
    "lookup_data_dir": os.path.abspath("../keys_data/GMO"),
    "model_data_dir": os.path.abspath("../model_data/GMO"),                                                                                    
    "model_version_csv": os.path.abspath("../keys_data/GMO/ModelVersion.csv"),
}
